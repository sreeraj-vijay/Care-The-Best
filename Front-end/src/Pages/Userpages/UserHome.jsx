...
import adoptimage from '../../assets/adopt2.avif';
...
function UserHome() {
  ...
  <div className="md:w-2/4 text-center md:text-left">
    <h2 className="text-4xl font-bold leading-tight pr-8 text-darkText">
      Take Care of <span className="text-brightGreen">Animals</span>
    </h2>
    <p className="text-lightText mt-5 text-lg pr-6">
      Animal adoption is a compassionate practice where individuals provide loving homes for mistreated animals. It offers a chance for a better life, promoting responsible ownership and creating fulfilling connections between pets and families.
    </p>
  ...
  <div className="w-full md:w-2/4 mt-6 md:mt-0">
    <img className="w-full h-auto rounded-lg" src={adoptimage} alt="img" />
  </div>
</div>
    ...
    <div className=" min-h-screen flex flex-col items-center md:px-32 px-5 my-10">
      <div className=" flex flex-wrap justify-center gap-6 mt-6">
        ...
        <Service img={animalVideocall} title="Vedio Call Session" discreption="Video calls with rescuers enhance animal aid, allowing visual assessment and collaborative decision-making to ensure swift and effective rescue efforts."/>
      </div>
    </div>
