...
const UserReortrescue = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      // Cleanup function to destroy the cropper instance
      if (cropper) {
        cropper.destroy();
      }
    };
      ...
      if (imageRef.current && reader.result) {
        ...
        const newCropper = new Cropper(imageRef.current, {
          ...
          crop: () => {
            ...
            setImage(croppedImage); // Set both selectedImage and image
          },
        });

        // Set the new cropper instance
...
export default UserReortrescue;
