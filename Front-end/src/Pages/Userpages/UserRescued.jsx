...
try{
    ...
    const animalData=await axiospath.post("/user/UserRescued",{email:userEmail})
...
return (
  ...
  currentPosts.length > 0 ? (
    ...
    <p className="p-24">No animals available</p>
  )
) : null}
