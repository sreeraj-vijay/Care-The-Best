...
function RescuerForgotpassword() {
    ...
    const handleForgotpassword = async (event) => {
      ...
      const rescuerdataString = JSON.stringify(rescuerdata);
      ...
      try {
        const res = await fetch(`${FETCH_BASE_URL}/rescuer/Forgotpassword`, {
          method: 'post',
          headers: {
        ...
        if (res.ok) {     
         ...
         const store = await dispatch(rescuerregister(data))
          Navigate('/Rescuer/RescuerForgotpasswordOtp')
          toast.success("Please Enter the otp");
        } else{
          toast.error('rescuer not Found');
  ...
  export default RescuerForgotpassword
